...
This sample uses the Azure JavaScript SDK with [`DefaultAzureCredential`](https://docs.microsoft.com/en-us/javascript/api/overview/azure/identity-readme?view=azure-node-latest#defaultazurecredential) to create a Virtual Machine.

Packages used:

[@azure/arm-network](https://www.npmjs.com/package/@azure/arm-network) 
<br>
[@azure/arm-compute](https://www.npmjs.com/package/@azure/arm-compute)
<br>
...
- Run `npm run create-virtual-machine.js` to run the sample.
